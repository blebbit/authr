...
export const APP_BLEBBIT_AUTHR_FOLDER_CREATE_FOLDER_RELATIONSHIP_DOC = {
  $flexicon: {
    lname: "folder",
    lplural: "folders",
  },
...
export type APP_BLEBBIT_AUTHR_FOLDER_CREATE_FOLDER_RELATIONSHIP_INPUT = {
  relation: string;
  resource: string;
  subject: string;
};
export const APP_BLEBBIT_AUTHR_FOLDER_CREATE_FOLDER_RELATIONSHIP_INPUT_SCHEMA =
