...
export const APP_BLEBBIT_AUTHR_FOLDER_RECORD_DOC = {
  defs: {
    main: {
      key: "tid",
      record: {
...
export type APP_BLEBBIT_AUTHR_FOLDER_RECORD = {
  cuid?: string;
  name?: string;
  public?: boolean;
};

export const APP_BLEBBIT_AUTHR_FOLDER_RECORD_SCHEMA = z.object({
