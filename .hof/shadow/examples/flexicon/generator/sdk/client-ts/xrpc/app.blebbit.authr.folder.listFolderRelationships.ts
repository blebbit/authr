...
import {
  ...
  APP_BLEBBIT_AUTHR_FOLDER_LIST_FOLDER_RELATIONSHIPS_OUTPUT_SCHEMA,
} from "../../common-ts";

export async function appBlebbitAuthrFolderListFolderRelationships(
  params: APP_BLEBBIT_AUTHR_FOLDER_LIST_FOLDER_RELATIONSHIPS_PARAMETERS,
): Promise<APP_BLEBBIT_AUTHR_FOLDER_LIST_FOLDER_RELATIONSHIPS_OUTPUT | any> {
  // check params
  const paramsCheck =
  ...
  return xrpcCall({
    nsid: "app.blebbit.authr.folder.listFolderRelationships",
    method: "GET",
    params,
  });
}
