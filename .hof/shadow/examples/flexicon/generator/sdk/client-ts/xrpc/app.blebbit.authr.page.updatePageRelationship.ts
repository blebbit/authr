...
export async function appBlebbitAuthrPageUpdatePageRelationship(
  payload: APP_BLEBBIT_AUTHR_PAGE_UPDATE_PAGE_RELATIONSHIP_INPUT,
): Promise<any> {
  // check payload
  const payloadCheck =
  ...
  return xrpcCall({
    nsid: "app.blebbit.authr.page.updatePageRelationship",
    method: "POST",
    payload,
  });
}
