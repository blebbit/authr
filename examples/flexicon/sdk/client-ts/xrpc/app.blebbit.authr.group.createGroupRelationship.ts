...
export async function appBlebbitAuthrGroupCreateGroupRelationship(
  payload: APP_BLEBBIT_AUTHR_GROUP_CREATE_GROUP_RELATIONSHIP_INPUT,
): Promise<any> {
  // check payload
  const payloadCheck =
  ...
  return xrpcCall({
    nsid: "app.blebbit.authr.group.createGroupRelationship",
    method: "POST",
    payload,
  });
}
