...
export async function appBlebbitAuthrGroupDeleteGroupRelationship(
  payload: APP_BLEBBIT_AUTHR_GROUP_DELETE_GROUP_RELATIONSHIP_INPUT,
): Promise<any> {
  // check payload
  const payloadCheck =
  ...
  return xrpcCall({
    nsid: "app.blebbit.authr.group.deleteGroupRelationship",
    method: "POST",
    payload,
  });
}
