...
export const APP_BLEBBIT_AUTHR_GROUP_UPDATE_GROUP_RELATIONSHIP_DOC = {
  $flexicon: {
    lname: "group",
    lplural: "groups",
  },
...
export type APP_BLEBBIT_AUTHR_GROUP_UPDATE_GROUP_RELATIONSHIP_INPUT = {
  relation: string;
  resource: string;
  subject: string;
};
export const APP_BLEBBIT_AUTHR_GROUP_UPDATE_GROUP_RELATIONSHIP_INPUT_SCHEMA =
