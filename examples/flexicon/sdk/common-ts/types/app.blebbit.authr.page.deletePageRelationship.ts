...
export const APP_BLEBBIT_AUTHR_PAGE_DELETE_PAGE_RELATIONSHIP_DOC = {
  $flexicon: {
    lname: "page",
    lplural: "pages",
  },
...
export type APP_BLEBBIT_AUTHR_PAGE_DELETE_PAGE_RELATIONSHIP_INPUT = {
  relation?: string;
  resource: string;
  subject: string;
};
export const APP_BLEBBIT_AUTHR_PAGE_DELETE_PAGE_RELATIONSHIP_INPUT_SCHEMA =
  z.object({
